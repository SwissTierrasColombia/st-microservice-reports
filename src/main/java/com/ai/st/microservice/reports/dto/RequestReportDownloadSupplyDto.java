...
public class RequestReportDownloadSupplyDto extends ReportRequestDto implements Serializable {
    ...
    public RequestReportDownloadSupplyDto() {
    ...
    public String toString() {
        return "RequestReportDownloadSupplyDto{" + "supplies=" + supplies + ", deliveryId='" + deliveryId + '\''
                + ", dateDelivery='" + dateDelivery + '\'' + ", managerName='" + managerName + '\'' + ", operatorName='"
                + operatorName + '\'' + ", municipalityCode='" + municipalityCode + '\'' + ", municipalityName='"
                + municipalityName + '\'' + ", departmentName='" + departmentName + '\'' + ", observations='"
                + observations + '\'' + ", dateCreation='" + dateCreation + '\'' + '}';
    }
}