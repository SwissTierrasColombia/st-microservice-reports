...
public final class ReportSuppliesSNR extends ReportBusiness {
    ...
    public ReportInformationDto generateReport(RequestReportSNRSuppliesDto requestDto)
        ...
        try {
            ...
            log.error("Error creando reporte pdf solicitudes atendidas SNR: " + e.getMessage());
