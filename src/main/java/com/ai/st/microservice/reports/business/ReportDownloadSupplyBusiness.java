...
public class ReportDownloadSupplyBusiness extends ReportBusiness {
    ...
    public ReportInformationDto generateReport(RequestReportDownloadSupplyDto deliveryDto) throws BusinessException {
        ...
        try {
            ...
            String messageError = String.format("Error creando reporte en pdf de descarga de insumos completo: %s",
                    e.getMessage());
