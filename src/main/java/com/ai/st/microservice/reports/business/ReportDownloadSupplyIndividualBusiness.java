...
@Service
public class ReportDownloadSupplyIndividualBusiness extends ReportBusiness {

	Logger log = LogManager.getLogger(ReportDownloadSupplyIndividualBusiness.class);

	public ReportInformationDto generateReport(RequestReportDownloadSupplyIndividualDto deliveryDto)
		...
		try {
			String pathFile = this.generateReportSimplePDF("/jasper/template_report_download_supply_individual.jrxml",
